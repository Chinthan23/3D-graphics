...
export class Shader
{
	constructor(gl, vertexShaderSrc, fragmentShaderSrc,type)
	{
		this.gl = gl;
	...
	readPixel(x,y){
		...
		this.gl.readPixels(x,y,1,1,this.gl.RGBA,this.gl.UNSIGNED_BYTE,pixelData);
		console.log(pixelData[0]+pixelData[1]<<8+pixelData[2]<<16+pixelData[3]<<24,pixelData);
		return pixelData;
	}
}